...
class PlotSkew:
    ...
    def plot_skewt(self):
        ...
        p = self.station_data['pressure'].values * units.hPa
        T = self.station_data['Temperature_isobaric'].values * units.degC
        Td = self.station_data['Dewpoint'].replace(np.nan, 0.0000001).values * units.degC
        u = self.station_data['u-component_of_wind_isobaric'].values * units('meters / second').to('knots')
        v = self.station_data['v-component_of_wind_isobaric'].values * units('meters / second').to('knots')
